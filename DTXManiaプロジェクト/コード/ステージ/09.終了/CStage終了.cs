			...
			if( !base.b活性化してない )
			{
                ...
                if( this.ct時間稼ぎ.n現在の値 < 2000 )
                {
                    if( this.tx文字 != null )
                    {
                        ...
                        this.tx文字2.t2D描画( CDTXMania.app.Device, 600 - ( 1.30f * this.ct時間稼ぎ.n現在の値), 1000 - ( 1.6f * this.ct時間稼ぎ.n現在の値), new System.Drawing.Rectangle( 0, 0, 620, 92 )  );
                        this.tx文字3.t2D描画( CDTXMania.app.Device, -300 + ( 1.10f * this.ct時間稼ぎ.n現在の値), 1000 - ( 1.6f * this.ct時間稼ぎ.n現在の値), new System.Drawing.Rectangle( 0, 92, 620, 94 )  );
                    }
                }
                else
                {
