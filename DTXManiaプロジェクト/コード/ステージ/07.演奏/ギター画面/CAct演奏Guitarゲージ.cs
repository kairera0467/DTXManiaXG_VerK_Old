			...
			if( !base.b活性化してない )
			{
                ...
                else if (CDTXMania.ConfigIni.eNamePlate == Eタイプ.B)
                {
                    ...
                    if ( base.txgbg != null && CDTXMania.DTX.bチップがある.Guitar )
                    {
                        ...
                        base.txgbar.vc拡大縮小倍率.X = 1f;
                        base.txgbar.t2D描画(CDTXMania.app.Device, 18, 10, new Rectangle(0, 0x1a, 0x1f8, 0x1a));
                    }
                    #endregion
                    #region [ ベースのゲージ ]
                    if ( base.txgbg != null && CDTXMania.DTX.bチップがある.Bass )
                    {
                        ...
                        base.txgbar.vc拡大縮小倍率.X = 1f;
                        base.txgbar.t2D描画(CDTXMania.app.Device, 940 + 13, 10, new Rectangle(0, 0x1a, 0x1f8, 0x1a));
                    }
                    #endregion
                }
