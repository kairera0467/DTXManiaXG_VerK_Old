                    ...
                    if (!base.st状態[j].ct進行.b停止中)
                    {
                        ...
                        if (CDTXMania.ConfigIni.nJudgeAnimeType < 2)
                        {
                            ...
                            if (j < 10)
                            {
                                ...
                                if( CDTXMania.ConfigIni.判定文字表示位置.Drums == Eタイプ.B )
                                    num6 = base.iP_A + (CDTXMania.ConfigIni.bReverse.Drums ? -(this.n文字の縦表示位置[j] * 0x20) : (this.n文字の縦表示位置[j] * 0x20));
                                else
                                    num6 = CDTXMania.ConfigIni.bReverse.Drums ? base.iP_B : base.iP_B;
                            }
                            else if (j == 11)
                            {
                            ...
                            //if (base.tx判定文字列[num4] != null)
                            {
                                ...
                                if (CDTXMania.ConfigIni.nJudgeAnimeType == 1 && CDTXMania.stage演奏ドラム画面.tx判定画像anime != null)
                                {
