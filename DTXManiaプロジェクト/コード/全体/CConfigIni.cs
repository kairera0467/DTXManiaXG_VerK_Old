...
namespace DTXMania
{
	internal class CConfigIni
	{
        ...
        */
		...
		public CConfigIni()
		{
            ...
            this.bAssignToLBD.Guitar = false;
            this.bAssignToLBD.Bass = false;
	...
	//------------------------------
            ...
            sw.WriteLine();
			sw.WriteLine( "; LP/LBD/BD 打ち分けモード(0:LP|LBD|BD, 1:LP&(LBD|BD), 2:LP&LBD&BD)" );		// #27029 2012.1.4 from
            sw.WriteLine( "; LP/LBD/BD Grouping     (0:LP|LBD|BD, 1:LP&(LBD|BD), 2:LP&LBD&BD)");
...
//			sw.WriteLine();																	//
            ...
            sw.WriteLine();
            sw.WriteLine("; ドラムRANDOMモード(0:OFF, 1:Random, 2:SuperRandom, 3:HyperRandom, 4:MasterRandom, 5:AnotherRandom)");
            sw.WriteLine("DrumsRandom={0}", (int)this.eRandom.Drums);
            sw.WriteLine();
            ...
            sw.WriteLine("; 4:タイプE GITADORA風の表示です。(実験的)");
									...
									case Eセクション種別.PlayOption:
										{
                                            ...
                                            {
                                                this.eNamePlate.Drums = (Eタイプ)C変換.n値を文字列から取得して範囲内に丸めて返す(str4, 0, 4, (int)this.eNamePlate.Drums);
                                            }
                                            ...
                                            else if (str3.Equals("DrumsRandom"))
                                            {
