...
namespace DTXMania
{
	internal class CActオプションパネル : CActivity
	{
        ...
        private readonly Rectangle[] rcDark = new Rectangle[] { new Rectangle(0x30, 0, 0x30, 0x12), new Rectangle(0x30, 18, 0x30, 0x12), new Rectangle(0x30, 126, 0x30, 0x12) };
        ...
        private readonly Rectangle[] rcPosition = new Rectangle[] { new Rectangle(0, 0x48, 0x30, 0x12), new Rectangle(0, 90, 0x30, 0x12), new Rectangle(0, 0x6c, 0x30, 0x12), new Rectangle(47, 72, 0x30, 0x12) };
