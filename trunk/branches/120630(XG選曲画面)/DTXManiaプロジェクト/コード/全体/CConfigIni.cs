...
namespace DTXMania
{
	internal class CConfigIni
	{
		...
		public CConfigIni()
		{
            ...
            this.eLaneType.Guitar = Eタイプ.A;
            this.eLaneType.Bass = Eタイプ.A;
            ...
            this.eHHOGraphics.Guitar = Eタイプ.A;
            this.eHHOGraphics.Bass = Eタイプ.A;
            this.eLBDGraphics = new STDGBVALUE<Eタイプ>();
            this.eLBDGraphics.Drums = Eタイプ.A;
            this.eLBDGraphics.Guitar = Eタイプ.A;
            this.eLBDGraphics.Bass = Eタイプ.A;
            this.eDkdkType = new STDGBVALUE<Eタイプ>();
            this.eDkdkType.Drums = Eタイプ.A;
            this.eDkdkType.Guitar = Eタイプ.A;
            this.eDkdkType.Bass = Eタイプ.A;
	...
	//------------------------------
			...
			sw.WriteLine();
			sw.WriteLine( "; LP/LBD/BD 打ち分けモード(0:HP|LBD|BD, 1:HP&LBD|BD 2:HP&LBD&BD)" );		// #27029 2012.1.4 from
...
//			sw.WriteLine();																	//
            ...
            sw.WriteLine("JudgeLine={0}", this.nJudgeLine);
            sw.WriteLine();
            sw.WriteLine("; シャッターINSIDE(0～100)");
            sw.WriteLine("ShutterIn={0}", this.nShutterInSide);
            sw.WriteLine();
            sw.WriteLine("; シャッターOUTSIDE(0～100)");
            sw.WriteLine("ShutterOut={0}", this.nShutterOutSide);
            sw.WriteLine();
            sw.WriteLine( "; フォルイン演出の表示(0:表示しない, 1:表示する)");
            sw.WriteLine("DrumsFillinEffect={0}", this.フィルイン演出を表示する ? 1 : 0);
            sw.WriteLine();
            ...
            sw.WriteLine();
            sw.WriteLine("; スキルモード(0:旧仕様, 1:XG仕様(バグ多目))");
								...
								switch( unknown )
								{
									...
									case Eセクション種別.System:
										...
										//----------------------------------------
                                            ...
                                            {
                                                this.nMovieAlpha = C変換.n値を文字列から取得して範囲内に丸めて返す(str4, 0, 0xffff, this.nMovieAlpha);
                                            ...
                                            {
                                                this.bShowScore = C変換.bONorOFF(str3[0]);
                                            }
									...
									case Eセクション種別.PlayOption:
										{
                                            ...
                                            {
                                                this.nJudgeLine = C変換.n値を文字列から取得して範囲内に丸めて返す(str4, 0, 100, this.nJudgeLine);
                                            }
                                            else if (str3.Equals("ShutterIn"))
                                            {
                                                this.nShutterInSide = C変換.n値を文字列から取得して範囲内に丸めて返す(str4, -100, 100, this.nShutterInSide);
                                            }
                                            ...
                                            {
                                                this.eNamePlate.Drums = (Eタイプ)C変換.n値を文字列から取得して範囲内に丸めて返す(str4, 0, 2, (int)this.eNamePlate.Drums);
                                            }
                                            ...
                                            else if (str3.Equals("MoveDrumSet"))				// #29500 2012.9.11 kairera0467
                                            {
                                                this.bドラムセットを動かす = C変換.bONorOFF(str4[0]);
                                            }
                                            else if (str3.Equals("DrumsFillinEffect"))
                                            {
                                                this.フィルイン演出を表示する = C変換.bONorOFF(str4[0]);
                                            }
