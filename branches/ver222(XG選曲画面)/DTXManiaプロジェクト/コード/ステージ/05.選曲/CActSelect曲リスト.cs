...
//			this.On非活性化();
		...
		public override int On進行描画()
		{
            ...
            CDTXMania.act文字コンソール.tPrint(50, 100, C文字コンソール.Eフォント種別.白, string.Format("PanelNumber:{0:#0}", this.nパネル番号));
		...
		#region [ private ]
		//-----------------
        public enum Eバー種別 { Score, Box, Other }
		...
		public STバー情報[] stバー情報 = new STバー情報[ 13 ];
