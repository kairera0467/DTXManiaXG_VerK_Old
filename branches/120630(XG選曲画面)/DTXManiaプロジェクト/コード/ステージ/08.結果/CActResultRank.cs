	...
	internal class CActResultRank : CActivity
	{
		...
		public override int On進行描画()
		{
			...
			if( base.b初めての進行描画 )
			{
                ...
                this.txランク文字.vc拡大縮小倍率.X = 1.3f;
                this.txランク文字.vc拡大縮小倍率.Y = 1.3f;
			...
			if( this.ctランク表示.n現在の値 >= 500 )
			{
				...
				{
					this.txランク文字.t2D描画( CDTXMania.app.Device, this.n本体X, this.n本体Y, new Rectangle( 0, 0, (int) ( 216.0 * num2 ), 0xd8 ) );
				}
			}
