...
namespace DTXMania
{
    internal class CAct演奏Drumsステータスパネル : CAct演奏ステータスパネル共通
    {
        public override void On活性化()
        {
            ...
            {
                if ((CDTXMania.DTX.bチップがある.LeftCymbal == true) || (CDTXMania.DTX.bチップがある.LP == true) || (CDTXMania.DTX.bチップがある.LBD == true) || (CDTXMania.DTX.bチップがある.FT == true) || (CDTXMania.DTX.bチップがある.Ride == true))
                {
        ...
        public override void OnManagedリソースの作成()
        {
            if (!base.b活性化してない)
            {
                ...
                this.nStrlengthbydot = (int)graphics.MeasureString(this.strPlayerName, this.ftDisplayFont).Width;
                this.nStrlengthbydot = (int)graphics.MeasureString(this.strGroupName, this.ftDisplayFont).Width;
                graphics.Dispose();
                ...
                if (this.nStrlengthbydot > 240)
                {
                    ...
                    {
                        graphics.DrawString(this.strPlayerName, this.ftNameFont, namecolor, (float)54f, (float)134f);
                        graphics.DrawString(this.strGroupName, this.ftGroupFont, Brushes.White, (float)54f, (float)104f);
                    }
...
//#if XG1風
                ...
                if (CDTXMania.ConfigIni.eNamePlate.Drums == Eタイプ.B)
                {
                    ...
                    identity *= SlimDX.Matrix.Translation(-980, 150, 0);
...
//#endif
                ...
                this.nCurrentScore = (long)CDTXMania.stage演奏ドラム画面.actScore.n現在の本当のスコア.Drums;
                ...
                for (int i = 0; i < 7; i++)
                {
                    ...
                    if (this.txScore != null)
                    {
                        ...
                        if (CDTXMania.ConfigIni.eNamePlate.Drums == Eタイプ.A)
                        {
                            matScoreXG *= SlimDX.Matrix.Translation(-768 + (i * 30), 112, 0);
