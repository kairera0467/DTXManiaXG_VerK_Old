...
namespace DTXMania
{
	internal class CAct演奏判定文字列共通 : CActivity
	{
		...
		public virtual void Start( int nLane, E判定 judge, int lag )
		{
			...
			if( ( ( nLane >= 10 ) || ( ( (Eタイプ) CDTXMania.ConfigIni.判定文字表示位置.Drums ) != Eタイプ.C ) ) && ( ( ( nLane != 13 ) || ( ( (Eタイプ) CDTXMania.ConfigIni.判定文字表示位置.Guitar ) != Eタイプ.C ) ) && ( ( nLane != 14 ) || ( ( (Eタイプ) CDTXMania.ConfigIni.判定文字表示位置.Bass ) != Eタイプ.C ) ) ) )
			{
