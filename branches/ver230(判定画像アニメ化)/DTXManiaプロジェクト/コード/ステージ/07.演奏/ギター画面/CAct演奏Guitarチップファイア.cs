...
namespace DTXMania
{
	internal class CAct演奏Guitarチップファイア : CAct演奏チップファイアGB
	{
		...
		#region [ private ]
		//-----------------
		private readonly Point[] pt中央 = new Point[] { new Point( 107, 155 ), new Point( 146, 155 ), new Point( 185, 155 ), new Point( 0x1f0, 155 ), new Point( 0x214, 155 ), new Point( 0x238, 155 ) };
		//-----------------
		#endregion
	}
}
